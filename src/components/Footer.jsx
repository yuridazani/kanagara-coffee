        ...
        <div className="container mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
                ...
                <div className="text-center md:text-left">
                    <h3 className="font-serif font-bold text-xl text-soft-white mb-2">
                        Kanagara Coffee & Space
                    </h3>
                    <p className="text-sm text-cream/60 leading-relaxed mb-4 max-w-md mx-auto md:mx-0">
                        A unique blend of warm Joglo tradition and minimalist modern design.
                    </p>
                    ...
                    <div className="flex items-start gap-2 text-sm text-cream/70 mb-4 justify-center md:justify-start">
                        ...
                        <span>Jl. Raya Pd. Jati No.1, Pagerwojo, Buduran, Sidoarjo</span>
                    </div>
                </div>

                {/* Right: Social Links & Actions */}
                <div className="text-center md:text-right">
                    <p className="text-sm font-medium text-cream mb-3">Terhubung dengan Kami</p>
            ...
            <div className="text-center">
                <p className="text-xs text-cream/50">
                    &copy; {new Date().getFullYear()} Kanagara Coffee & Space. Crafted with 
                    <Heart size={12} className="inline mx-1 text-red-400" fill="currentColor" />
                    for coffee lovers.
                </p>
            </div>
        </div>
