            ...
            <div className="container mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="mt-6 bg-white p-6 rounded-lg shadow-lg">
                            <div className="flex items-start mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-charcoal/80">Jl. Raya Pd. Jati No.1, Pagerwojo, Kec. Buduran, Kabupaten Sidoarjo, Jawa Timur 61252</p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                <Clock size={24} className="text-wood-brown mr-4 flex-shrink-0 mt-1" />
                                <div>
                                    <h3 className="font-bold text-charcoal">Jam Buka</h3>
                                    <p className="text-charcoal/80">Setiap Hari: 10:00 - 23:00 WIB</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-left">
                        <h2 className="font-serif font-black text-4xl text-wood-brown">Temukan Ketenangan di Setiap Sudut</h2>
