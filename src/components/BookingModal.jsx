...
const BookingModal = ({ isOpen, onClose }) => {
    ...
    const handleSubmit = (e) => {
        ...
        const newReservation = {
            ...
            ...formData,
            type: bookingType,
            area: bookingType === 'meja' ? area : 'N/A', // Area hanya relevan untuk tipe 'meja'
                ...
                <div className="p-8">
                    {isSubmitted ? (
                        <div className="text-center py-10">
                            ...
                            <p className="mt-2 text-charcoal/80">Terima kasih. Tim kami akan segera menghubungi Anda via WhatsApp.</p>
                        </div>
                    ) : (
                        <>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-4">
                                    <div><label htmlFor="name" className="font-bold">Nama</label><input type="text" id="name" value={formData.name} onChange={handleInputChange} required className="mt-1 w-full p-2 border rounded-md" /></div>
                                    <div><label htmlFor="whatsapp" className="font-bold">Nomor WhatsApp</label><input type="tel" id="whatsapp" value={formData.whatsapp} onChange={handleInputChange} required className="mt-1 w-full p-2 border rounded-md" /></div>
                                </div>
