...
const TopBar = () => {
  ...
  useEffect(() => {
    ...
    // Set interval untuk refresh notifikasi setiap 30 detik
  ...
  const fetchNotifications = () => {
    ...
    axiosClient.get('/notifications')
      .then(({ data }) => {
        console.log('Notifications fetched successfully:', data); // Debug log
  ...
  const handleMarkAsRead = (id) => {
    axiosClient.post(`/notifications/${id}/read`).then(() => {
      // Pindahkan notifikasi dari unread ke read secara lokal
          ...
          {isNotifOpen && (
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border z-50 max-h-96 overflow-y-auto">
              <div className="p-4 border-b">
                <h3 className="font-bold text-charcoal flex items-center justify-between">
                  Notifikasi
                  <button 
              ...
              <div className="max-h-80 overflow-y-auto">
                ...
                {notifications.unread.length > 0 ? (
                  <div className="p-2">
                    <p className="text-xs font-semibold text-gray-600 mb-2">BELUM DIBACA</p>
                ...
                {notifications.read.length > 0 && (
                  <div className="p-2">
                    <p className="text-xs font-semibold text-gray-600 mb-2">SUDAH DIBACA</p>
