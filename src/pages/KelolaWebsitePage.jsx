    ...
    return (
        <div className="bg-soft-white p-6 lg:p-8 rounded-xl shadow-lg space-y-8">
            <div className="flex justify-between items-center">
                <h1 className="font-serif font-black text-3xl text-wood-brown">Kelola Konten Website</h1>
                <button 
                    onClick={() => {
            ...
            <fieldset className="border p-4 rounded-lg space-y-4">
                <legend className="font-bold text-xl px-2">1. Pengaturan Umum</legend>
                
                {/* Hero Tagline */}
                <div>
                    <label className="font-bold block mb-2">Hero Tagline</label>
                    <input 
                        name="hero_tagline" 
                    ...
                    />
                    <small className="text-gray-500">Tagline yang akan muncul di hero section halaman utama</small>
                </div>

                {/* About Text */}
                <div>
                    <label className="font-bold block mb-2">Teks Tentang Kami</label>
                    <textarea 
                        name="about_text" 
                        ...
                        className="w-full p-3 border rounded-md focus:outline-none focus:border-wood-brown"
                    />
                    <small className="text-gray-500">Deskripsi yang akan muncul di section Tentang Kami</small>
                </div>

                {/* Google Maps URL */}
                <div>
                    <label className="font-bold block mb-2">Google Maps Embed URL</label>
                    <input 
                        name="gmaps_url" 
                        ...
                        className="w-full p-3 border rounded-md focus:outline-none focus:border-wood-brown"
                    />
                    <small className="text-gray-500">URL embed Google Maps (bukan URL biasa). Ambil dari Google Maps → Share → Embed</small>
                </div>

                {/* About Image */}
                <div>
                    <label className="font-bold block mb-2">Gambar About (Opsional)</label>
                    {settings?.about_image_path && (
                        <div className="mb-2">
                            ...
                            />
                            <small className="text-gray-500 block">Gambar saat ini</small>
                        </div>
                    )}
            ...
            {/* Hero Images Section */}
            <fieldset className="border p-4 rounded-lg space-y-4">
                <legend className="font-bold text-xl px-2">2. Gambar Hero (Maksimal 5)</legend>
                <p className="text-sm text-gray-600 mb-4">
                    Gambar hero akan ditampilkan sebagai slider di halaman utama. 
                    Anda bisa menambahkan hingga 5 gambar.
                </p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                    ...
                    {hero_images && Array.from({ length: 5 - hero_images.length }, (_, i) => (
                        <div key={`empty-${i}`} className="w-full h-24 border-2 border-dashed border-gray-300 rounded-md flex items-center justify-center">
                            <span className="text-gray-400 text-xs">Slot {hero_images.length + i + 1}</span>
                        </div>
                    ))}
                </div>
            </fieldset>
            ...
            {/* Fasilitas Section */}
            <fieldset className="border p-4 rounded-lg space-y-4">
                <legend className="font-bold text-xl px-2">3. Fasilitas</legend>
                <p className="text-sm text-gray-600 mb-4">
                    Centang fasilitas yang aktif untuk ditampilkan di website.
                </p>
            ...
            {/* Galeri Section */}
            <fieldset className="border p-4 rounded-lg space-y-4">
                <legend className="font-bold text-xl px-2">4. Galeri Foto</legend>
