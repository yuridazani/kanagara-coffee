                ...
                <div className="w-24 h-24 flex-shrink-0 relative overflow-hidden">
                    {imageUrl ? (
                        ...
                        <div className="w-full h-full bg-gradient-to-br from-wood-brown/20 to-wood-brown/10 flex items-center justify-center">
                            <span className="text-wood-brown/60 text-xs">No Image</span>
                        </div>
                    )}
                    {item.tag !== 'None' && (
        ...
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group" data-aos="fade-up">
            <div className="relative h-40 overflow-hidden">
                {imageUrl ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-wood-brown/20 to-wood-brown/10 flex items-center justify-center">
                        <span className="text-wood-brown/60 text-sm">No Image</span>
                    </div>
                )}
                {item.tag !== 'None' && (
                    ...
                    <div className="container mx-auto">
                        ...
                        <div className="text-center mb-8 relative bg-gradient-to-r from-wood-brown to-light-brown rounded-lg shadow-lg py-12 px-8" data-aos="fade-up">
                            <div className="relative z-10">
                                <h1 className="font-serif font-black text-3xl md:text-5xl text-white">Our Full Menu</h1>
                                <p className="mt-3 text-white/90 max-w-2xl mx-auto">Jelajahi semua pilihan kopi, hidangan, dan camilan terbaik yang kami siapkan.</p>
                            </div>
                        </div>

                        {/* --- FILTER & VIEW TOGGLE KOMPAK --- */}
                        ...
                        <div className={
                            ...
                            {filteredMenu.length > 0 ? (
                                ...
                                <div className="col-span-full text-center py-12 text-gray-500">
                                    <p className="text-lg">Tidak ada menu yang ditemukan</p>
                                    <p className="text-sm">Coba ubah filter kategori atau label</p>
                                </div>
                            )}
                        </div>
                    </div>
